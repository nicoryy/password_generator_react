  ...
  return (
    <div className="bg-[#292929] grid place-items-center h-100v w-full font-JetBrains text-white selection:bg-purple-900 selection:text-purple-950">
      <div className="bg-purple-800 grid place-items-center px-10 py-8 rounded-md">
        ...
        <div className="flex gap-5 px-4 py-2 h-10 bg-purple-950 rounded-md w-96 justify-center relative my-5">
          <span>{Password}</span>
        ...
        <div className="grid w-96 gap-2 grid-cols-2 text-sm">
          <div className="flex gap-4 relative">
            ...
            <IoCheckmark
              size={16}
              className="absolute right-2.5 top-0.5 text-white transition-opacity opacity-0 pointer-events-none peer-checked:opacity-100"
            />
          </div>
          ...
          <div className="flex gap-4 relative">
            <label htmlFor="number">IncludeAll Numbers</label>
            <input
          ...
          <button
            ...
            className="w-[200%] bg-purple-950 mt-5 p-3 rounded-lg hover:border border-purple-500 outline-none "
          >
            {" "}
            Generate Password{" "}
          </button>
